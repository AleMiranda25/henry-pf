...
const Navbar = () => {
  ...
  return (
    <div className="navbar z-10 bg-[#202123] text-[whitesmoke] mx-auto px-2 fixed top-[0] left-[0] w-full">
      <div className="navbar-start">
        {(location.pathname === "/" || location.pathname === "/user" || location.pathname.includes("/services")) && (

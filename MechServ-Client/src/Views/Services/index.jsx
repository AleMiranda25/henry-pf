              ...
              <div className="flex flex-row justify-between">
                ...
                { offset>0 && 
                  <button onClick={() => setOffset(offset-1)}> 
                    <i className="hover:text-[#5770F4] h-auto w-12 rounded-badge fa-solid fa-chevron-left fa-xl text-[whitesmoke] opacity-95 hover:opacity-80 cursor-pointer"></i> 
                  </button>}
                </div>
                ...
                { offset>=0 && offset<Math.trunc(services.length/8) && 
                  <button onClick={() => setOffset(offset+1)}>
                    <i className="hover:text-[#5770F4] h-auto w-12 rounded-badge fa-solid fa-chevron-right fa-xl text-[whitesmoke] opacity-95 hover:opacity-80 cursor-pointer"></i>
                  </button>}
                </div>
              </div>
